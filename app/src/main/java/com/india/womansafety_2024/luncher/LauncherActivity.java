package com.india.womansafety_2024.luncher;
...
import com.india.womansafety_2024.RegisterActivity;
...
public class LauncherActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.layout_login_user).setOnClickListener(onClickListener);
...
//        getSupportActionBar().hide();
   ...
   View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            int id =v.getId();
            if(id==R.id.layout_login_user)
                gotoSingUp(1);
            else if(id==R.id.layout_enroll)
                gotoSingUp(2);
        }
    };
