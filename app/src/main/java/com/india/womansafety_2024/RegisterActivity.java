...
import com.india.womansafety_2024.Guardian.GuardianMainActivity;
import com.india.womansafety_2024.databinding.ActivityMainBinding;
import com.india.womansafety_2024.luncher.LauncherActivity;
import com.india.womansafety_2024.model.Guardian;
import com.india.womansafety_2024.model.User;
import com.india.womansafety_2024.user.UserMainActivity;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mAuth = FirebaseAuth.getInstance(Objects.requireNonNull(Objects.requireNonNull(FirebaseApp.initializeApp(RegisterActivity.this))));
    ...
    private void addUser() {
        DatabaseReference mDatabase = FirebaseDatabase.getInstance(FirebaseApp.initializeApp(RegisterActivity.this)).getReference();
        //getTocken();
        String token = SharedPrefUtils.getStringData(SharedPrefConst.AUTH_KEY);
        Log.e(TAG, "addUser: "+token );
        if (userType == 2) {
           // String token = SharedPrefUtils.getStringData(SharedPrefConst.AUTH_KEY);
